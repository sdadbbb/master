...
class UITestResultManager:
    """UI自动化测试结果管理器"""

    def __init__(self):
        self.results_dir = os.path.join(FileUtil.get_project_root(), 'reports', 'ui_results')
        os.makedirs(self.results_dir, exist_ok=True)

    def save_result(self, task_id, results, case_names=None):
        """保存批量测试结果"""
